...
namespace SAM.API
{
    public static class Steam
    {
        ...
        public static bool Load()
        {
            ...
            // 64 位进程加载 steamclient64.dll，32 位进程加载 steamclient.dll
            ...
            foreach (var candidate in candidates)
            {
                ...
                module = Native.LoadLibraryEx(candidate, IntPtr.Zero, Native.LoadWithAlteredSearchPath);
                if (module != IntPtr.Zero) break;
            }
